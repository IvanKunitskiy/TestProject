...
public class AddAccountPage extends PageTools {
    ...
    private final By interestFrequency = By.xpath("//div[@id='interestfrequency']/a/span/span[contains(@class, 'ng-scope')]");
    ...
    public void setEscrowPaymentValue(String escrow) {
        waitForElementVisibility(escrowPayment);
        type(escrow, escrowPayment);
    }
}
