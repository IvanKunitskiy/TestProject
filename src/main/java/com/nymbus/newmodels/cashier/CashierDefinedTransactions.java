...
public enum CashierDefinedTransactions {
    ...
    INCOMING_WIRE_TO_SAVINGS_FEE("INCOMING WIRE TO SAVINGS"),
    OUTGOING_WIRE_FROM_SAVINGS("OUTGOING DOM WIRE FROM SAVINGS"),
    OFFICIAL_CHECK_FROM_SAVINGS("OFFICIAL CHECK FROM SAV"),
    MONEY_ORDER_FROM_SAVINGS("MONEY ORDER FROM SAVINGS"),
    OFFICIAL_CHECK_WITH_CASH("OFFICIAL CHECK WITH CASH"),
    TRANSFER_FROM_SAV_TO_CHK_Print_Notice_On_Entry("TRANSFER FROM SAV TO CHK (Print Notice = On Entry)"),
    AUTOMATION_SAV_TO_CHK_CDT("AUTOMATION_SAV_TO_CHK_CDT");
