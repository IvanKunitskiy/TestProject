...
public class C22664_CommitWithdrawAndCloseSavingsTest extends BaseTest {
    ...
    public void prepareTransactionData() {
        ...
        // Set products
        savingsAcc.setProduct(Actions.productsActions().getProduct(Products.SAVINGS_PRODUCTS, AccountType.REGULAR_SAVINGS, RateType.FIXED));
        ...
        double transactionAmount = AccountActions.retrievingAccountData().getCurrentBalanceWithAccruedInterestForCycle();
