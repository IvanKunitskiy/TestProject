...
@Owner("Dmytro")
public class C19471_CDVoidT2TBetweenCashDrawersTransactionByAprroverConfirmInitiatorCashOut extends BaseTest {
    ...
    @TestRailIssue(issueID = 19471, testRunName = TEST_RUN_NAME)
    @Test(description = "C19471, [CD] Void T2T between Cash Drawers transaction by approver + Confirm Void by initiator (Cash Out)")
    ...
    public void cDVoidT2TBetweenCashDrawersTransactionByInitiatorCashOut() {
        ...
        logInfo("Step 12: [workstration1, teller1] :\n" +
        ...
        logInfo("Step 13: [Workstration1, Teller1 ]:\n" +
                "Go to Teller to Teller Transfer screen again");
        Pages.aSideMenuPage().clickTellerToTellerMenuItem();

        logInfo("Step 14: [Workstration1, Teller1 ]:\n" +
                "Click [Confirm Void] button");
        Pages.tellerToTellerPage().clickConfirmVoidButton();
        ...
        logInfo("Step 15: [Workstration1, Teller1 ]:\n" +
                "Go to Cash Drawer screen and verify fields for approver:\n" +
                "- Cash out total on the left part of the screen (if Teller1 was selected as cash out)\n" +
                "- Denominations used in committed transaction");
        Pages.aSideMenuPage().clickCashDrawerMenuItem();
        ...
        logInfo("Step 16: [Workstration2, Teller2]:\n" +
                "Go to Cash Drawer screen and verify fields for Approver:\n" +
                "- Cash in total on the left part of the screen (if Teller2 was selected as cash in)\n" +
                "- Denominations used in the committed transaction");
        Actions.loginActions().doLogOutProgrammatically();
        ...
        logInfo("Step 17: [Workstration2, Teller2] :\n" +
                "Go to Teller to Teller Transfer screen and search for Voided transaction");
        b = Pages.tellerToTellerPage().noTransactionsByNumber(numberTransfer);
        TestRailAssert.assertTrue(b, new CustomStepResult("Transactions is not visible","Transactions is visible"));
