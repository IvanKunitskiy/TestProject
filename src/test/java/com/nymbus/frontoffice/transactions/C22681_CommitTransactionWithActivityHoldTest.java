...
@Owner("Petro")
public class C22681_CommitTransactionWithActivityHoldTest extends BaseTest {
    ...
    public void preCondition() {
        ...
        ActivityHoldInstruction activityHoldInstruction = instructionConstructor.constructInstruction(ActivityHoldInstruction.class);
    ...
    @TestRailIssue(issueID = 22681, testRunName = TEST_RUN_NAME)
    @Test(description = "C22681, Commit transaction with activity hold")
    @Severity(SeverityLevel.CRITICAL)
    public void commitTransactionWithActivityHoldTest() {
