...
@Owner("Dmytro")
public class C19475_CDT2TBetweenCashDrawersAprroveCashIn extends BaseTest {
    ...
    @TestRailIssue(issueID = 19475, testRunName = TEST_RUN_NAME)
    @Test(description = "C19475, [CD] T2T between Cash Drawers + approve (Cash In)")
    ...
    public void cDVoidT2TBetweenCashDrawersTransactionByInitiatorCashOut() {
        ...
        Pages.tellerToTellerPage().clickAction("In");
        ...
        logInfo("Step 6: [Workstration1, Teller1]:\n" +
                "Go to Cash Drawer page and verify fields for the Creator:\n" +
                "- Cash In total on the left part of the page (if Teller1 was selected as cash In)\n" +
        ...
        logInfo("Step 8: [Workstration2, Teller2]:\n" +
                "Go to Cash Drawer page and log in to proof date\n" +
                "verify fields for Approver:\n" +
                "- Cash Out total on the left part of the page (if Teller2 was selected as cash out)\n" +
                "- Denominations used in the committed transaction");
        Pages.aSideMenuPage().clickCashDrawerMenuItem();
        Actions.transactionActions().doLoginTeller();
        ...
        logInfo("Step 11: [Workstration2, Teller2]:\n" +
                "Go to Cash Drawer page and verify fields for approver:\n" +
                "- Cash Out total on the left part of the page (if Teller2 was selected as cash out)\n" +
                "- Denominations used in the committed transaction");
        Pages.aSideMenuPage().clickCashDrawerMenuItem();
        TestRailAssert.assertEquals(Pages.cashDrawerBalancePage().getCashOut(),
