...
public class C22748_CDTWithoutTellerSessionCommitIncomingWireWithFeeTransactionAmountNotChanged extends BaseTest {
    ...
    @TestRailIssue(issueID = 22748, testRunName = TEST_RUN_NAME)
    @Test(description = "C22748,CDT without Teller Session - Commit incoming wire with fee, transaction amount not changed")
