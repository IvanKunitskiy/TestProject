...
@Owner("Dmytro")
public class C26611_ZeroDollarAVSTest extends BaseTest {
    ...
    @TestRailIssue(issueID = 26611, testRunName = TEST_RUN_NAME)
    @Test(description = "C26611, Zero Dollar AVS")
    @Severity(SeverityLevel.CRITICAL)
    public void verifyZeroDollarAVSTest() {
        ...
        Assert.assertEquals(actualBalanceData.getCurrentBalance(), expectedBalanceDataForCheckingAcc.getCurrentBalance(),
                "CHK account current balance is not correct!");
        Assert.assertEquals(actualBalanceData.getAvailableBalance(), expectedBalanceDataForCheckingAcc.getAvailableBalance(),
        ...
        Assert.assertEquals(instructionsCount, 0,"Instruction was created");
        ...
        Assert.assertEquals(transactionDescription, "Deferred Debit Purchase Pre-Authorization",
                "Transaction description is not equal to 'Deferred Debit Purchase Pre-Authorization'");
    }
    ...
    private Map<String, String> getFieldsMap(NonTellerTransactionData transactionData) {
        ...
        result.put("48", "SHELL");
        result.put("49", "840");
        result.put("58", "10000000182");
        result.put("63", "B0IN9015DSDACQRID");
        result.put("111", "12345678901234567890");
        result.put("123", "TDAV15XXXXXXXXXX 0CV0711XXX P");
        result.put("124", "NI02PS00");
        result.put("127", "001100000000065422");
