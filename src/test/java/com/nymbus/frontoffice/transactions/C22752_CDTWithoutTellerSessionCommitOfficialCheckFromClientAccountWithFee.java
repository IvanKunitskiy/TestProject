...
public class C22752_CDTWithoutTellerSessionCommitOfficialCheckFromClientAccountWithFee extends BaseTest {
    ...
    @TestRailIssue(issueID = 22752, testRunName = TEST_RUN_NAME)
    ...
    public void printTellerReceiptWithoutBalance() {
        ...
        logInfo("Step 2: Go to Cashier Defined Transactions screen");
        ...
        logInfo("Step 9: Click [Commit] again;\n" +
                "Select customer or create a new one and click [Verify] button;\n" +
                "Click [No] button");
        Actions.transactionActions().clickCommitButton();
        Pages.verifyConductorModalPage().clickVerifyButton();
        Pages.confirmModalPage().clickNo();
