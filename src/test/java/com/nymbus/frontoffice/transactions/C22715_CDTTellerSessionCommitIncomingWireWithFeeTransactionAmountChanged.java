...
public class C22715_CDTTellerSessionCommitIncomingWireWithFeeTransactionAmountChanged extends BaseTest {
    ...
    @TestRailIssue(issueID = 22715, testRunName = TEST_RUN_NAME)
    @Test(description = "C22715, CDT+Teller Session - Commit incoming wire with fee, transaction amount changed")
