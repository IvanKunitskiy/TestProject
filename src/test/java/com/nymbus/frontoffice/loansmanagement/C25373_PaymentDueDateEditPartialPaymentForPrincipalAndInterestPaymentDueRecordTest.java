...
@Owner("Petro")
public class C25373_PaymentDueDateEditPartialPaymentForPrincipalAndInterestPaymentDueRecordTest extends BaseTest {
    ...
    @Test(description = "C25373, Payment Due Date: Edit Partial Payment for Principal and Interest payment due record")
    ...
    public void paymentDueDateEditPartialPaymentForPrincipalAndInterestPaymentDueRecord() {
        ...
        TestRailAssert.assertTrue(Pages.accountPaymentInfoPage().getPaymentDueTypeFromRecordByIndex(1).equals(PaymentAmountType.PRINCIPAL_AND_INTEREST.getPaymentAmountType()),
        ...
        logInfo("Step 10: Change 'Payment Amount' to the value < paid amount from step 4 and click 'Save' button");
        Pages.accountPaymentInfoPage().typePaymentAmount(Functions.getStringValueWithOnlyDigits(transaction416Amount - diff));
