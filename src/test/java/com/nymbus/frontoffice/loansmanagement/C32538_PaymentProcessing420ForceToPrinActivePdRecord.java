...
@Owner("Petro")
public class C32538_PaymentProcessing420ForceToPrinActivePdRecord extends BaseTest {
    ...
    @TestRailIssue(issueID = 32538, testRunName = TEST_RUN_NAME)
    @Test(description = "C32538, Payment Processing: 420 - Force To Prin, Active PD record")
    @Severity(SeverityLevel.CRITICAL)
    public void paymentProcessing420ForceToPrinActivePdRecord() {
        ...
        TestRailAssert.assertTrue(transactionAmount_420.equals(String.valueOf(transactionAmount)),
        ...
        TestRailAssert.assertTrue(amount.equals(String.valueOf(transactionAmount)),
                new CustomStepResult("'Amount' is not valid", "'Amount' is valid"));
        TestRailAssert.assertTrue(principal.equals(String.valueOf(transactionAmount)),
