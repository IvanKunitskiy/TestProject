...
public class C25479_ProcessLoanPrepaymentTransactionTest extends BaseTest {
    ...
    public void process416LoanPaymentTransaction() {
        ...
        TestRailAssert.assertTrue(interest.equals(expectedInterest),
        ...
        TestRailAssert.assertTrue(paidInterest == Double.parseDouble(expectedInterest), new CustomStepResult("Paid interest is not valid",
