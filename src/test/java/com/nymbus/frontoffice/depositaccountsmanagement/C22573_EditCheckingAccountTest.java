...
public class C22573_EditCheckingAccountTest extends BaseTest {
    ...
    @TestRailIssue(issueID = 22573, testRunName = TEST_RUN_NAME)
    ...
    public void editCheckingAccount() {
        ...
        logInfo("Step 6: Look at the field 'Account Type' and verify that such field is not disabled for editing");
