...
@Owner("Petro")
public class C19440_CdCrEcCashInWithCashRecyclerTest extends BaseTest {
    ...
    public void preConditions() {
        ...
        // Perform another 'Cash In' transaction
        Actions.loginActions().doLogin(userCredentials.getUserName(), userCredentials.getPassword());
        Actions.transactionActions().goToTellerPage();
    ...
    @TestRailIssue(issueID = 19440, testRunName = TEST_RUN_NAME)
    @Test(description = "C19440, [CD+CR] EC Cash In with Cash Recycler")
    @Severity(SeverityLevel.CRITICAL)
    public void CdCrEcCashInWithCashRecyclerTest() {
        ...
        TestRailAssert.assertEquals(actualCashRecyclerData.getHundredsAmount(), cashRecyclerData.getHundredsAmount(),
